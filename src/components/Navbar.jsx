            ...
            <div className="container flex justify-between px-(--padding-inline)">
                ...
                >
                    <div className="md:hidden relative z-30">
                        <Menu
                            className="cursor-pointer active:scale-85 transition border-2 border-(--primary-color) p-2 rounded-lg size-10"
                        ...
                        <AnimatePresence>
                            {openMenu && (
                                ...
                                >
                                    <Link
                                        className={`${pathname === "/" ? "active" : ""} header-link`}
                                        to={"/"}
                                    >
                                        Home
                                    </Link>
                                    <Link
                                        className={`${pathname === "/service" ? "active" : ""} header-link`}
                                        to={"/service"}
                                    >
                                        Service
                                    </Link>
                                    <Link
                                        className={`${pathname === "/doctors" ? "active" : ""} header-link`}
                                        to={"/doctors"}
                                    >
                                        Doctors
                                    </Link>
                                    <Link
                                        className={`${pathname === "/about" ? "active" : ""} header-link`}
                                        to={"/about"}
                                    >
                                        About us
                                    </Link>
                    ...
                    <div style={{ gap: "10px" }} className="hidden md:flex">
                        ...
                        <Button
                            text={"Sign up"}
                            primary={false}
                            onClick={() => setOpenSignUpForm((prev) => !prev)}
                        />
                    </div>
                </div>
            </div>
